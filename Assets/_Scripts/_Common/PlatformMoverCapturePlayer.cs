...
public class PlatformMoverCapturePlayer: MonoBehaviour {
	...
	void Movement() {
		...
		if ((myWaypoints.Length != 0) && (_moving)) {
			...
			if(Vector3.Distance(myWaypoints[_myWaypointIndex].transform.position, _transform.position) <= .10) {
				_myWaypointIndex++;
