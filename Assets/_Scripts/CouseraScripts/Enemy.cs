...
public class Enemy : MonoBehaviour , IStunnable{
	...
	[Tooltip("Un Stunned Trigger animation.")]
	public string unStunnedTrigger = "Stand";
	...
	void Awake() {
		...
		// 
		Physics2D.IgnoreLayerCollision( _enemyLayer, LayerMask.NameToLayer("Coin"), true); 
	}
